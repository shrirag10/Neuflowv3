...
confidence signal is the more consequential capability: permitting the model to
abstain on its least confident 20\% of queries yields 1.06\px\ mean error against
the baseline's 2.32\px\ over the remaining 80\% of the frame. We further
