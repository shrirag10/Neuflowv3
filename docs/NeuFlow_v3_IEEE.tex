...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{../results/plots/scenarios_illustrated_tight.png}
...
\begin{table}[t]
\caption{Required margin at two motion scales, in pixels, measured with the
baseline network.}
\label{tab:margin}
\centering
\begin{tabular}{lrrrr}
...
\IfFileExists{../results/plots/scenarios_tartanair_tight.png}{%
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../results/plots/scenarios_tartanair_tight.png}
\caption{The same three scenarios on aerial sequences, whose mean inter-frame
motion is a third of the driving case. Region geometry and decoder
