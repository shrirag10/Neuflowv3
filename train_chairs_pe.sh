#!/bin/bash
# =============================================================================
#  NeuFlow v3 — chairs + convex head + Fourier PE (sub-pixel awareness ablation)
#
#  Same recipe as train_v2dev.sh but stage=chairs (22,232 pairs, 384x512 crop).
...
CKPT_DIR="checkpoints/neuflowv3_chairs_pe"
